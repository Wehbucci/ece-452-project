# Project Null Pointers Week 1 Update
...
- split the project proposal roles for this week:
  ...
  - Ady – Use Case Diagram
  - Leo – User Scenarios
  - Richard – Functional Requirements
  - Hasan – Non-Functional Requirements + Timeline
  - Ali – Design Considerations
- the roles were just assigned this week, so the proposal work itself has not yet been completed
